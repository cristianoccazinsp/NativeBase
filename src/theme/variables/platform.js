...
export default {
  ...
  // CheckBox
  CheckboxRadius: platform === PLATFORM.IOS ? 10 : 0,
  CheckboxBorderWidth: platform === PLATFORM.IOS ? 1 : 2,
  CheckboxPaddingLeft: platform === PLATFORM.IOS ? 2 : 2,
  CheckboxPaddingBottom: platform === PLATFORM.IOS ? 2 : 1,
  CheckboxIconSize: platform === PLATFORM.IOS ? 18 : 16,
  CheckboxIconMarginTop: platform === PLATFORM.IOS ? 0 : 0,
  CheckboxFontSize: platform === PLATFORM.IOS ? 17 : 17,
